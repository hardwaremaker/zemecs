...
<hr>
<form name="bde" action="<%= response.encodeURL(theClient.getSContextServletPath() + "?cmd=" + TheApp.CMD_ZE_BDESTATION3+"&done=true") %>" method="post">
<p align="right">
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="50%">
      <p> <font face="Verdana">&nbsp;<b> <%=((java.util.HashMap)theClient.getData()).get("beleg")%></b></font>
    </td>
  </tr>
  <tr>
    <td width="50%" align="right">
